...
void LinuxWindow::init(const WindowCfg& cfg)
{
    ...
    glfwSetWindowCloseCallback(m_window, [](GLFWwindow* window) {
        ...
        Ref<WindowClosedEvent> e = createRef<WindowClosedEvent>(
                WindowClosedEvent());
    ...
    glfwSetWindowSizeCallback(m_window, [](GLFWwindow* window,
        ...
        Ref<WindowResizedEvent> e = createRef<WindowResizedEvent>(
    ...
    glfwSetKeyCallback(m_window, [](GLFWwindow* window,
        ...
        switch (action) {
            case GLFW_PRESS: {
                Ref<KeyPressedEvent> e = createRef<KeyPressedEvent>(
            ...
            case GLFW_REPEAT: {
                Ref<KeyPressedEvent> e = createRef<KeyPressedEvent>(
                        KeyPressedEvent(key, true));
                data.eventCallback(e);
                break;
            }
            case GLFW_RELEASE: {
                Ref<KeyReleasedEvent> e = createRef<KeyReleasedEvent>(
    ...
    glfwSetMouseButtonCallback(m_window, [](GLFWwindow* window,
        ...
        switch (action) {
            case GLFW_PRESS: {
                Ref<MousePressedEvent> e = createRef<MousePressedEvent>(
                        MousePressedEvent(button));
                data.eventCallback(e);
                break;
            }
            case GLFW_RELEASE: {
                Ref<MouseReleasedEvent> e = createRef<MouseReleasedEvent>(
    ...
    glfwSetCursorPosCallback(m_window, [](GLFWwindow* window,
        ...
        Ref<MouseMovedEvent> e = createRef<MouseMovedEvent>(
    ...
    glfwSetScrollCallback(m_window, [](GLFWwindow* window,
        ...
        Ref<MouseScrolledEvent> e = createRef<MouseScrolledEvent>(
